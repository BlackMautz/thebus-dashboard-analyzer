...
return [
    ...
    'paths' => [
        'operating_plan' => 'Community-Server-Heinsberg',  // ← HIER deinen OperatingPlan-Ordner eintragen
        'vehicle_fleet' => 'Multiplayer',          // ← HIER deinen VehicleFleet-Ordner eintragen
    ],
